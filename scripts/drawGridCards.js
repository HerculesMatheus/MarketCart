...
function drawGridCards(params) {
  ...
  p.innerText = `R$ ${params.price}`;
  p.classList.add("card__price");
  p.setAttribute("value", params.price);
  p.setAttribute("discount", params.discounts ? params.discounts : "0");
